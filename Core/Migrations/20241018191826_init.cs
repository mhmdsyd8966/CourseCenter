    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExamsStudent", x => new { x.ExamsId, x.StudentsId });
                    table.ForeignKey(
                        name: "FK_ExamsStudent_Exams_ExamsId",
                        column: x => x.ExamsId,
                        principalTable: "Exams",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_ExamsStudent_Student_StudentsId",
                        column: x => x.StudentsId,
                        principalTable: "Student",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuestionAnswer1 = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    QuestionAnswer2 = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    QuestionAnswer3 = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    QuestionAnswer4 = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExamsStudent_StudentsId",
                table: "ExamsStudent",
                column: "StudentsId");
